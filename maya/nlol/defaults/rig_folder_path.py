...
# rig_folderpath = Path(defaults.__file__).parent / "standalone_modules" / "quadruped_leg_mod"
# rig_folderpath = Path(defaults.__file__).parent / "standalone_modules" / "wing_mod"
# rig_folderpath = Path(defaults.__file__).parent / "standalone_modules" / "tail_mod"
# rig_folderpath = Path(defaults.__file__).parent / "standalone_modules" / "flexi_spine_mod"
# rig_folderpath = Path(defaults.__file__).parent / "standalone_modules" / "piston_simple_mod"
