...
def build_rigging_list():
    ...
    rigging_list = [
        shelf_separator,
        {
            ...
            "command": "from nlol.core.rig_components import create_joint\n"
            "from importlib import reload\n"
            "reload(create_joint)\n"
        ...
        },
        {
            ...
            "doubleClickCommand": "from nlol.core.rig_components import create_locators\n"
            "from importlib import reload\n"
            "reload(create_locators)\n"
        ...
        },
        {
            ...
            "command": "from nlol.core.rig_tools import replace_curves\n"
            "from importlib import reload\n"
        ...
        },
        {
            ...
            "command": "from nlol.core.rig_tools import mirror_curve_shapes\n"
            "from importlib import reload\n"
        ...
        shelf_separator,
        {
            ...
            "command": "from nlol.core.rig_tools import rig_delete\n"
            "from importlib import reload\n"
            "reload(rig_delete)\n"
        ...
        },
        {
            ...
            "command": "from nlol.core.standalone import run_test\n"
            "from importlib import reload\n"
            "reload(run_test)\n"
            "run_test.test()",
            "sourceType": "python",
        ...
        },
        {
            ...
            "command": "from nlol.core.rig_components import follicle_at_surface\n"
        ...
        shelf_separator,
        {
            ...
            "backgroundColor": random_clrs[12],
            "command": "from nlol.core.rig_tools import skin_export_import\n"
